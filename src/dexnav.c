...
STATIC_ASSERT(FLAG_SYS_DEXNAV_GET != 0, DexNavGetFlag);
STATIC_ASSERT(FLAG_SYS_DETECTOR_MODE != 0, DexNavDetectorModeFlag);
STATIC_ASSERT(VAR_DEXNAV_SPECIES != 0, DexNavSpeciesVar);
STATIC_ASSERT(VAR_DEXNAV_STEP_COUNTER != 0, DexNavStepCounterVar);
#endif
