...
// Flag/var defines
#define FLAG_SYS_DEXNAV_SEARCH          FLAG_UNUSED_0x8E5 // Searching for mon
#define FLAG_SYS_DEXNAV_GET             FLAG_UNUSED_0x8E6 // Dexnav shows in start menu
#define FLAG_SYS_DETECTOR_MODE          FLAG_UNUSED_0x8E7 // Allow player to find hidden mons
#define VAR_DEXNAV_SPECIES              VAR_UNUSED_0x40F7 // Registered dexnav species
#define VAR_DEXNAV_STEP_COUNTER         VAR_UNUSED_0x40F8 // Steps for finding hidden pokemon
